...
class BasicToken(IconScoreBase):
    ...
    def on_install(self, decimals: int = 0, name: str = None, symbol: str = None, message: str = None, totalSupply : int = None) -> None:
        super().on_install()

        if name is None:
            name = 'Trusted Car Token'
        if symbol is None:
            symbol = 'TCT'
        ...
        self._balances[self.msg.sender] = totalSupply
